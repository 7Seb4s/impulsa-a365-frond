...
// src/app/core/guards/guardia-autenticacion.ts
var guardiaAutenticacion = () => {
...
// src/app/configuracion-rutas.ts
var routes = [
  ...
  {
    path: "auth/login",
    loadComponent: () => import("./chunk-P6LQDKAA.js").then((m) => m.LoginComponent)
  },
  {
    path: "auth/recuperar",
    loadComponent: () => import("./chunk-YTO75YZQ.js").then((m) => m.RecuperarComponent)
  },
  // â”€â”€ RUTAS PRIVADAS (requieren token JWT vÃ¡lido) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  {
    ...
    children: [
      ...
      {
        path: "agente",
        loadComponent: () => import("./chunk-6WZ6ADXL.js").then((m) => m.DashboardAgenteComponent)
      },
      // Vista del administrador/gerente (con grÃ¡ficos)
      {
        path: "admin",
        loadComponent: () => import("./chunk-CVJ37EKX.js").then((m) => m.DashboardAdminComponent)
      },
      // Formulario para crear un nuevo usuario (solo admin/gerente)
      {
        path: "usuarios/crear",
        loadComponent: () => import("./chunk-VAS7Q2QO.js").then((m) => m.CrearUsuarioComponent)
      },
      // Panel de usuarios (admin) â† NUEVO
      {
        path: "panel-usuarios",
        loadComponent: () => import("./chunk-P2DNSTGZ.js").then((m) => m.PanelUsuariosComponent)
      },
      // Vista de tickets
      {
        path: "tickets",
        loadComponent: () => import("./chunk-CU5IQG6B.js").then((m) => m.TicketsComponent)
      },
      // Vista de incidencias
      {
        path: "incidencias",
        loadComponent: () => import("./chunk-DXRM3Y64.js").then((m) => m.IncidenciasComponent)
      },
      // Vista de perfil
      {
        path: "perfil",
        loadComponent: () => import("./chunk-OFS6NPCY.js").then((m) => m.PerfilComponent)
      },
      // Vista de configuraciÃ³n
      {
        path: "configuracion",
        loadComponent: () => import("./chunk-O2GHIDOC.js").then((m) => m.ConfiguracionComponent)
      },
      // Vista de reportes
      {
        path: "reportes",
        loadComponent: () => import("./chunk-JVU6N3R2.js").then((m) => m.ReportesComponent)
      },
      // Vista de gestiÃ³n de tickets (admin)
      {
        path: "gestion-tickets",
        loadComponent: () => import("./chunk-2NZZ4ZWK.js").then((m) => m.GestionTicketsComponent)
      },
      // Vista de gestiÃ³n de incidencias (admin)
      {
        path: "gestion-incidencias",
        loadComponent: () => import("./chunk-SLSWCOG5.js").then((m) => m.GestionIncidenciasComponent)
      },
      // Vista de administraciÃ³n (admin) â† NUEVO
      {
        path: "administracion",
        loadComponent: () => import("./chunk-3MDTTQC5.js").then((m) => m.AdministracionComponent)
      },
      ...
      // Panel de tickets del tÃ©cnico (aprobar)
      {
        ...
        loadComponent: () => import("./chunk-NOVBGR6Y.js").then((m) => m.TecnicoTicketsComponent)
      },
      // Panel de incidencias del tÃ©cnico (asignar / derivar)
      {
        path: "tecnico/incidencias",
        loadComponent: () => import("./chunk-B2YEFSNE.js").then((m) => m.TecnicoIncidenciasComponent)
      },
      // Perfil del tÃ©cnico (con la barra lateral del tÃ©cnico)
      {
        path: "tecnico/perfil",
        loadComponent: () => import("./chunk-VSWPCH4S.js").then((m) => m.TecnicoPerfilComponent)
      }
    ]
  },
  ...
  {
    path: "restablecer",
    loadComponent: () => import("./chunk-3JNAMFY7.js").then((m) => m.RestablecerComponent)
  },
  // Cualquier ruta desconocida â†’ login
  { path: "**", redirectTo: "auth/login" }
];

// src/app/core/interceptors/interceptor-autenticacion.ts
var interceptorAutenticacion = (peticion, siguiente) => {
  const servicioAuth = inject(ServicioAutenticacion);
